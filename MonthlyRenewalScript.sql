...
-- Activate and Deactivate CustomerPlans
-- get status values 
...
update CP set StatusLookupId = @activeStatusId , 
	ModifiedBy = 'RenewalService',
	ModifiedDate = @date,
	Notes = notes + ';' + 'Activated by renewal service'
from prov.CustomerPlan CP where StatusLookupId = @tobeactivatedstatusId

update CP set StatusLookupId = @cancelledStatusId,
	ModifiedBy = 'RenewalService',
	ModifiedDate = @date,
	Notes = notes + ';' + 'Cancelled by renewal service'
from prov.CustomerPlan CP where StatusLookupId = @activeStatusId
	and CP.TerminationDate <= @monthStartDate
